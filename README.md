...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/aged-scene-5d9f
```

A live public deployment of this template is available at [https://aged-scene-5d9f.templates.workers.dev](https://aged-scene-5d9f.templates.workers.dev)
